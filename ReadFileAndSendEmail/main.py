# Utilizado manipular arquivo
import pandas as pd
# Usado para enviar SMS
# Cadastro: https://www.twilio.com/pt-br/docs/libraries/python
...
diretorio = 'ReadFileAndSendEmail/'
# Abrir os 6 arquivos em Excel
lista_meses = ['janeiro', 'fevereiro', 'março', 'abril', 'maio', 'junho']

for mes in lista_meses:
    # f formatar string dinamico
    tabela_vendas = pd.read_excel(diretorio + f'{mes}.xlsx')
